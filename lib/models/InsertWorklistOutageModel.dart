class InsertWorklistOutageModel {
  String _reqNo;
  String _regionCode;
  String _menuMainID;
  String _menuSubID;
  ...
  InsertWorklistOutageModel({
    ...
    this._doOrNot = doOrNot;
    this._reasonNot = reasonNot;
  }
  ...
  String get isMainLine => _isMainLine;
  set isMainLine(String isMainLine) => _isMainLine = isMainLine;
  String get doOrNot => _doOrNot;
  set doOrNot(String doOrNot) => _doOrNot = doOrNot;
  String get reasonNot => _reasonNot;
  set reasonNot(String reasonNot) => _reasonNot = reasonNot;

  InsertWorklistOutageModel.fromJson(Map<String, dynamic> json) {
    _reqNo = json['Req_No'];
    ...
    _isMainLine = json['Is_MainLine'];
    _doOrNot = json['DoOrNot'];
    _reasonNot = json['Reason_Not'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['Is_MainLine'] = this._isMainLine;
    data['DoOrNot'] = this._doOrNot;
    data['Reason_Not'] = this._reasonNot;
    return data;
  }
}
